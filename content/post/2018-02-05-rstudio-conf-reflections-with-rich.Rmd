...
{{< img-post path="img/rstudio_images" file="kobe.gif" alt="Touchdown" type="center" >}}
...
{{< img-post path="img/rstudio_images" file="krista_rich.jpg" alt="Krista interviewing Rich" type="center" >}}
...
## Photos
{{< img-post path="img/rstudio_images" file="hadley.jpg" alt="Hadley Wickham talking about "Big Ideas"" type="center" >}}

{{< img-post path="img/rstudio_images" file="hex.jpg" alt="Hex sticker mania, Part I" type="center" >}}

{{< img-post path="img/rstudio_images" file="rich.jpg" alt="Rich Pauloo" type="center" >}}  
[Rich Pauloo](https://richpauloo.github.io)

{{< img-post path="img/rstudio_images" file="nik.jpg" alt="Niklas Lollo" type="center" >}}

{{< img-post path="img/rstudio_images" file="tacos.jpg" alt="Fish Tacos... yummm" type="center" >}}
